...
class DatatablesController extends Controller
{
	...
	public function ebtData()
	{
		...
		->select('dataebt.id_data', 'dataebt.tahun', 'dataebt.terpasang', 'dataebt.kwhr', 'dataebt.kwh', 'dataebt.data_keterangan', 'anggaran.nama_anggaran', 'energi.nama_energi', 'provinsi.nama_provinsi', 'kabupaten.nama_kabupaten', 'kecamatan.nama_kecamatan', 'kelurahan.nama_kelurahan');
		return Datatables::of($devices)
    ->escapeColumns()
    ->make(true);
	}
